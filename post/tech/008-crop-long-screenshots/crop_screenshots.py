...
if __name__ == "__main__":
    input_folder = "/home/m/Documents/nordic_cabin/screenshots"    # Input folder path
    output_folder = input_folder + "3:45" # Output folder path
    crop_ratio = (3, 4.5)                 # Desired crop ratio (width:height)
